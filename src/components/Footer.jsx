      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/services#general-checkups" className="text-sm hover:text-primary-400 transition-colors">General Dentistry</Link></li>
              <li><Link to="/services#teeth-whitening" className="text-sm hover:text-primary-400 transition-colors">Cosmetic Dentistry</Link></li>
              <li><Link to="/services#orthodontics" className="text-sm hover:text-primary-400 transition-colors">Orthodontics & Braces</Link></li>
              <li><Link to="/services#dental-implants" className="text-sm hover:text-primary-400 transition-colors">Dental Implants</Link></li>
              <li><Link to="/services#pediatric-dentistry" className="text-sm hover:text-primary-400 transition-colors">Pediatric Care</Link></li>
            </ul>
          </div>
