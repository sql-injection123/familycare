          ...
          <div className="space-y-8">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center text-center">
                ...
                <a href="https://wa.me/0770260489" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-secondary-600 font-bold hover:underline mt-auto">
                  <span>Chat Now</span>
                </a>
              </div>
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100">
              ...
              <div className="aspect-[16/9] w-full bg-slate-200 rounded-xl overflow-hidden relative">
                ...
                <iframe 
                  ...
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3846.5418129323145!2d28.3725453!3d-15.378051!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x19408c4e0d9b5b5b%3A0x6790757a7f459ba4!2sFamily%20Care%20Dental%20Surgery!5e0!3m2!1sen!2szm!4v1710150000000!5m2!1sen!2szm" 
                  loading="lazy" 
